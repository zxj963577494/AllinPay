...
namespace AllinPayWeb.AllinPay
{
    public class AllinPayRSA
    {
        ...
        public static string RSASignCharSet(string data, string privateKey, string charset)
        {
            ...
            byte[] signatureBytes = oRSA3.SignData(messagebytes, "SHA1");
            return AllinPayCore.ByteToHexStr(signatureBytes);
        }
        ...
        public static bool verify(string content, string signedString, string publicKey, string input_charset)
        {
            try
            {
                ...
                byte[] data = AllinPayCore.HexStringToByteArray(signedString);
